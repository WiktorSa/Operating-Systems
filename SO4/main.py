...
if __name__ == '__main__':
    ...
    result = Result(no_pages, start_pages, end_pages, localities_of_reference, how_large_localites,
                    how_often_localities)
    result.get_results(no_simulations, no_frames, time_frame, l, u, h, c)
