class LRU:
    def __init__(self, time_frame, c):
        self.frames = None
        ...
        # Overall number of page errors in one simulation
        self.overall_no_page_errors_algorithm = 0

    def forward(self, page, no_algorithm):
        ...
        self.overall_no_page_errors_algorithm += page_error
    ...
    def change_frames(self, no_frames):
    ...
    def set_original_number_of_frames(self, no_frames):
        self.frames = [0] * no_frames

    # Reset settings to perform simulation using different algorithm
    def reset(self):
        self.frames = None
        self.pages_in_memory = []
        self.errors_in_time_frame = [0] * self.time_frame
        self.pages_in_time_c = [0] * self.c
        self.overall_no_page_errors_algorithm = 0
